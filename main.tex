...
\input{./bibs/glossary.tex} % Include the glossary definitions
...
\begin{document}
	% Mis macros
	\include{./resources/macros}
	
	\frontmatter % Parte introductoria
	
	% Portada
	\include{./caps/portada}
	% \cleardoublepage
	...
	% Capítulos
	\include{./caps/intro}
	\include{./caps/mate-bases}
	%	\include{caps/python}
	\include{./caps/fundamentales}
	\include{./caps/aproximados}
	\include{./caps/unidim}
	%	\include{caps/dinamica}
